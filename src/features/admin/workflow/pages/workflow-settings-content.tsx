        ...
        <div className="flex flex-1 flex-col gap-6 p-6">
            <div>
                ...
                <p className="text-sm text-muted-foreground">
                    System-wide loan workflow configuration. Changes apply to
                            ...
                            <div className="flex items-center justify-between gap-4 rounded-md border p-4">
                                <div className="space-y-0.5">
                                    <p className="text-sm font-medium">
                                        Require recommendation before evaluation
                                    </p>
                                    <p className="text-xs text-muted-foreground">
                                        ...
                                        {config.data?.source === "AppConfig" && (
                                            <>
                                                {" "}
                                                · from server configuration (no
                                                admin override yet)
                                            </>
                                        )}
                                    </p>
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>
                            {pending ? "Enable" : "Disable"} the recommendation
                            step?
                        </AlertDialogTitle>
                        <AlertDialogDescription>
                            <div className="space-y-2 text-sm">
                                ...
                                <ul className="list-disc space-y-1 pl-4 text-xs text-muted-foreground">
                                    <li>
                                        Applies to{" "}
                                        <strong>new submissions only</strong>,
                                        immediately.
                                    </li>
                                    <li>
                                ...
                                {!pending && (backlog.data ?? 0) > 0 && (
                                    <p className="flex items-start gap-1.5 rounded-md border border-amber-300 bg-amber-50 p-2 text-xs text-amber-800">
                                        ...
                                        currently waiting for recommendation.
                                        Recommenders can still process them.
                                    </p>
                                )}
                            </div>
                        </AlertDialogDescription>
