...
import { useDeskQueue, useClaimNext, type QueuedLoanDto } from "@/src/hooks/use-desk-queue";
import { formatWaiting, waitingMinutes } from "@/src/pages/dashboard/components/pending-queue";
